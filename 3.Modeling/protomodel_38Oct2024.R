...
### get the lambda 1.se
lambda_1se <- model.full.out$elastic.cv$lambda.1se
lambda_1se
...
model_path <- "/Users/nmbryce/Documents/R/SRA/2024-Statistical-Risk-Assessment/3.Modeling/main_full_cv_glmnet_object_30Oct_newWBdata.rds"
model.2023 <- readRDS(model_path)

#get the lambda (1se)
lambda_1se <- model.2023$lambda.1se
lambda_1se
